        ...
        <Fragment>
            ...
            <div className='fleSecond'>
                ...
                <div className="program_set">
                    ...
                    <Link to=''>Каталог PRO</Link><img alt='' src={require('../../../images/icon-right-arrow-verylong.svg')}/>
                </div>
            </div>
            <div className="listP">
