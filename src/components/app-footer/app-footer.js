...
const AppFooter = () => {
    return (
        <div className="footerB">
            <img alt='' src={require('../../images/logo-footer.svg')}/>
            <div><Link to='/'>
                <svg viewBox="0 0 22 12" id="icon-vk-mobile"><title>icon-vk-mobile</title>
                    <path
                ...
                <Link to='/'>
                    <svg viewBox="0 0 16 16" id="icon-insta-mobile"><title>icon-insta-mobile</title>
                        <path className="st0"
                        ...
                        <circle className="st0" cx="12.3" cy="3.7" r=".9"/>
                    </svg>
                </Link>
                <Link to='/'>
                    <svg viewBox="0 0 10 19" id="icon-fb-mobile"><title>icon-fb-mobile</title>
                        <path
